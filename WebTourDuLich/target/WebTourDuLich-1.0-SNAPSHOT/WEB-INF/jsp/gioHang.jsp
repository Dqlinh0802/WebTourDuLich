    ...
    <div class="container mr-auto ml-auto">
        <div class="d-flex justify-content-between">
            <a href="<c:url value="/dsTour"/>">
                <i class="fas fa-arrow-left ml-4 text-white"></i>
            </a>
        ...
        <div class="d-flex justify-content-center">
            <c:if test="${nguoiDungDangNhap.id != null}">
                <input type="button" onclick="thanhToan(${nguoiDungDangNhap.id}, ${demSLTour})" 
            ...
            <c:if test="${nguoiDungDangNhap.id == null}">
                <div class="col-md-8 p-4 d-inline-flex justify-content-between border border-white">
                    <div class="d-inline">
                        ...
                        <br /><br />
                        <a href="<c:url value="/dangNhap" />" class="btn btn-normal border-white text-white">Đăng nhập</a>
                    </div>
                    ...
                    <div class="d-inline">
                        ...
                        <br />
                        <a href="<c:url value="/dangKy" />" class="btn btn-normal border-white text-white">Đăng ký</a>
                    </div>
                </div>
            </c:if>
        </div>
